...
const TableSelect = ({tableOptions, selectTable, currentTable}):JSX.Element => {
    ...
    return <div id="select-table">
                <label htmlFor="tables" className="breakdown-label">Choose a Table: </label>
                <select name="tables" className="breakdown-input" id="tables" value={currentTable} onChange={(ev) => {
